...
- Added time-of-day pain summaries to record summaries, grouping pain records by late night, morning, afternoon, and night without assessing causes or medication effects.
...
- Unified management action labels.

### Fixed
- Improved edit-dialog keyboard behavior with Escape close, focus trapping, validation focus, and focus return after save or close.
